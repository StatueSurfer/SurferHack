...
NEARDATA struct permonst mons[] = {
    ...
    /*
     * quadrupeds
     */ //rebalancing team q, since it's sort of ridiculous that a mumak is more threatening than a mastodon. - StatueSurfer, 2/4/18
    ...
    MON("mumak", S_QUADRUPED, LVL(5, 9, 0, 0, -2), (G_GENO | 1),
        A(ATTK(AT_BUTT, AD_PHYS, 2, 12), ATTK(AT_BITE, AD_PHYS, 2, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("leocrotta", S_QUADRUPED, LVL(6, 18, 4, 10, 0), (G_GENO | 2),
        ...
        M3_INFRAVISIBLE, CLR_RED),
    MON("wumpus", S_QUADRUPED, LVL(8, 15, 2, 10, 0), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 3, 6), ATTK(AT_BUTT, AD_PHYS, 4, 4), NO_ATTK, 
			NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("titanothere", S_QUADRUPED, LVL(12, 12, 6, 0, 0), (G_GENO | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 8), ATTK(AT_BUTT, AD_PHYS, 4, 6), 
			NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(2650, 650, MS_SILENT, MZ_LARGE), 0, 0,
        M1_ANIMAL | M1_THICK_HIDE | M1_NOHANDS | M1_HERBIVORE,
        M2_HOSTILE | M2_STRONG, M3_INFRAVISIBLE, CLR_GRAY),
    MON("baluchitherium", S_QUADRUPED, LVL(18, 15, 2, 0, 0), (G_GENO | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 5, 8), ATTK(AT_CLAW, AD_PHYS, 5, 8), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(3800, 800, MS_SILENT, MZ_LARGE), 0, 0,
        M1_ANIMAL | M1_THICK_HIDE | M1_NOHANDS | M1_HERBIVORE,
        M2_HOSTILE | M2_STRONG, M3_INFRAVISIBLE, CLR_GRAY),
    MON("mastodon", S_QUADRUPED, LVL(25, 15, -1, 0, 0), (G_GENO | 1),
        A(ATTK(AT_BUTT, AD_PHYS, 8, 8), ATTK(AT_BUTT, AD_PHYS, 8, 8), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(3800, 800, MS_SILENT, MZ_LARGE), 0, 0,
        M1_ANIMAL | M1_THICK_HIDE | M1_NOHANDS | M1_HERBIVORE,
    ...
    MON("pony", S_UNICORN, LVL(3, 16, 6, 0, 0), (G_GENO | 2),
	 ...
	 /* making unicorns ungenocidable to prevent abusive revgenoing to farm luck - StatueSurfer, 12/24/17 */
    MON("white unicorn", S_UNICORN, LVL(4, 24, 2, 70, 7), (2),
    ...
    MON("gray unicorn", S_UNICORN, LVL(4, 24, 2, 70, 0), (1),
        A(ATTK(AT_BUTT, AD_PHYS, 1, 12), ATTK(AT_KICK, AD_PHYS, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1300, 300, MS_NEIGH, MZ_LARGE), MR_POISON, MR_POISON,
        M1_NOHANDS | M1_HERBIVORE, M2_WANDER | M2_STRONG | M2_JEWELS,
        M3_INFRAVISIBLE, CLR_GRAY),
    MON("black unicorn", S_UNICORN, LVL(4, 24, 2, 70, -7), (1),
        A(ATTK(AT_BUTT, AD_PHYS, 1, 12), ATTK(AT_KICK, AD_PHYS, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1300, 300, MS_NEIGH, MZ_LARGE), MR_POISON, MR_POISON,
        M1_NOHANDS | M1_HERBIVORE, M2_WANDER | M2_STRONG | M2_JEWELS,
	...
	/*MON("disintegrative vortex", S_VORTEX, LVL(15, 22, 2, 30, 0), //added by StatueSurfer, 2/4/18
		(G_HELL | G_GENO | G_NOCORPSE | 1),
		A(ATTK(AT_ENGL, AD_DISN, 2, 10), NO_ATTK, NO_ATTK, 
			NO_ATTK, NO_ATTK, NO_ATTK),
		SIZ(0, 0, MS_SILENT, MZ_HUGE),
		MR_DISINT | MR_ELEC | MR_SLEEP | MR_POISON | MR_STONE, 0,
		M1_FLY | M1_BREATHLESS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD
			| M1_MINDLESS | M1_UNSOLID,
	 ...
	 *
	 * Gave all dragons speed buffs. Babies to 12, adults to 20 
	 * - StatueSurfer, 12/21/17
     */
    MON("baby gray dragon", S_DRAGON, LVL(12, 12, 2, 10, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("baby silver dragon", S_DRAGON, LVL(12, 12, 2, 10, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(1500, 500, MS_ROAR, MZ_HUGE), 0, 0,
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_CARNIVORE,
...
#endif
    MON("baby red dragon", S_DRAGON, LVL(12, 12, 2, 10, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("baby yellow dragon", S_DRAGON, LVL(12, 12, 2, 10, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
...
struct permonst _mons2[] = {
    ...
    MON("sergeant", S_HUMAN, LVL(8, 10, 10, 5, -3), (G_SGROUP | G_GENO | 1),
        ...
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_HUMAN | M2_MERC | M2_STALK
                                       | M2_HOSTILE | M2_STRONG | M2_COLLECT,
        M3_INFRAVISIBLE, CLR_RED),
    MON("nurse", S_HUMAN, LVL(11, 6, 0, 0, 0), (3), //renders nurses ungenocidable to block nurse dancing - StatueSurfer, 12/23/17
...
#define SEDUCTION_ATTACKS_NO                                      \
     ...
     */
    MON("Juiblex", S_DEMON, LVL(50, 3, -7, 65, -15), //buffed by StatueSurfer, 12/17/17
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        ...
        M1_AMPHIBIOUS | M1_AMORPHOUS | M1_NOHEAD | M1_FLY | M1_SEE_INVIS
            | M1_ACID | M1_POIS | M1_UNSOLID, /* Lord Juiblex laughs at your now-useless wand of digging */
    ...
    MON("Baalzebub", S_DEMON, LVL(89, 9, -5, 85, 20),
        ...
        HI_LORD),
    MON("Asmodeus", S_DEMON, LVL(45, 12, -7, 90, 20), //Asmodeus is a joke... imagine this line: "Asmodeus touches you! "Eat slime and die!"" and taking no damage - StatueSurfer, 12/18/17
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        A(ATTK(AT_TUCH, AD_PHYS, 0, 0), ATTK(AT_MAGC, AD_COLD, 6, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("healer", S_HUMAN, LVL(10, 12, 10, 1, 0), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_MAGC, AD_CLRC, 0, 0), NO_ATTK, //also added spells for healers, StatueSurfer, 2/4/18
			NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), MR_POISON, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_HUMAN | M2_STRONG | M2_COLLECT, M3_INFRAVISIBLE,
    ...
    MON("wizard", S_HUMAN, LVL(10, 12, 10, 3, 0), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_MAGC, AD_SPEL, 0, 0), NO_ATTK, //gave wizards spellcasting - StatueSurfer, 2/4/18
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
