    ...
    if (otmp->otyp == AMULET_OF_YENDOR) {
        ...
        too_soon:
            ...
            if (altaralign == A_NONE) {
			  ...
			  else if (u.ualign.type == altaralign && u.ualign.record < 0) { //can't ascend with negative alignment -StatueSurfer, 12/17/17
				godvoice(altaralign, "You have transgressed, mortal! You shall not gain my favor like this!");
			} else { /* super big win */
                adjalign(10);
